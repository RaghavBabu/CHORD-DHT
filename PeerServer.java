...
/**
 * Class PeerServer. Main class which gets input form user to add,
 * leave a node and insert, search a file.
 * @author Raghav Babu
 * Date : 02/26/2016
 */
public class PeerServer {
	...
	public PeerServer(){
		...
		try {
			nodeIP = InetAddress.getLocalHost().getHostAddress().toString();
		} catch (UnknownHostException e) {
			System.out.println("Exception while getting current node IP Address "+e);
			e.printStackTrace();
		}
	 ...
	 * @param command
	 */
	private void processCommand(String cmd, String fileName) {
	 ...
	 */
	private void insertFile(String command, String fileName) {
